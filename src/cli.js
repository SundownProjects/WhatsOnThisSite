...
const { WhatsOnThisSite } = require('./driver');
...
Examples:
  wots https://www.example.com
  node cli.js https://www.example.com -r -D 3 -m 50 -H "Cookie: username=admin"
  docker wots/cli https://www.example.com --pretty
...
(async () => {
  ...
  try {
    ...
    const site = await wots.open(url, headers, storage);
